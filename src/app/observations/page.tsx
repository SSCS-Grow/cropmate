...
async function fetchObservations(q: string) {
  ...
  const res = await fetch(`${base}/api/observations${q}`, { cache: "no-store" });
...
export default async function ObservationsPage({
  ...
  /** Next 15: searchParams er asynkron i Server Components */
  searchParams: Promise<SP>;
}) {
  // 👇 VIGTIGT: await INDEN du bruger properties
